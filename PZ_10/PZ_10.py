...
# Список книг, встречающихся не во всех магазинах
print("Список книг, встречающихся не во всех магазинах:\n",
      f"{(Magistr.union(DomKnigi, BookMarket, Galereya)).difference(Magistr.intersection(DomKnigi, BookMarket, Galereya))}\n",
      '-----------------------------------------------------------')
